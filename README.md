...
## 🚀 About Me  
I am a highly motivated **Computer Science graduate** with a Bachelor's in Computer Engineering. I have hands-on experience as a Backend Developer Intern at prominent tech firms, specializing in developing and optimizing APIs and server-side systems using frameworks like Django REST and Express.js. Passionate about building scalable solutions and deploying them using cloud platforms like Microsoft Azure, I thrive in collaborative environments and enjoy solving complex problems.  
...
*Implemented hand gesture recognition using classical ML (KNN, SVM with Hu Moments and convexity defects) and deep learning (ResNet18).* *Achieved 98.98% accuracy on a dataset of 24,000 images, outperforming traditional methods (~93%).* **Tech Stack:** Python, OpenCV, scikit-learn, PyTorch  

### **[Book Cart](https://github.com/prit2410/BookCartLibraryApp)** 📚  
*Created a mobile app that enables users to search, browse, and access library books.* *Developed database integration for efficient book retrieval and cataloging.* **Tech Stack:** Java, Android Studio, Firebase  
...
## 📖 Publication
* Khadka A. & Desai P. Comparative Evaluation Traditional Machine Learning Models and Deep CNN for Static Hand Gesture Recognition. 2025.
* Computer Science and Engineering Student Research Series, No. 2. University of Texas at Arlington.

---

## 🏆 Certifications & Awards  
- **Java Programming Masterclass** – Udemy  
- **Winner: Poster Presentation, Enviro-Tech 1.0**
- **Web Development Masterclass** – Udemy  

---  

💡 *I am always open to collaborations and exciting projects!* 🚀  
📩 *Feel free to reach out via [email](mailto:pritdesa@gmail.com) or [LinkedIn](https://www.linkedin.com/in/prit-desai-36545412b/).*
